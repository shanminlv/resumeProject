...
/***/ function(module, exports) {
	...
	module.exports = "<!DOCTYPE html><html lang=\"en\"><head>\t<meta charset=\"UTF-8\">\t<meta name=\"viewport\"    content=\"width=device-width,user-scalable=no,initial-scale=1.0,maximum-scale=1,minimum-scale=1\">\t<title>My resume</title></head><body id=\"body\">\t<div class=\"wrapper\">\t\t<section id=\"top\"></section> \t\t<section id=\"content\">\t\t\t<div class=\"left\">\t\t\t\t<div class=\"mywork\" >\t\t\t\t\t<div class=\"bigTitle work\">\t\t\t\t\t\t<div class=\"titleName\">\t\t\t\t\t\t\t\t<p>工作经验</p>\t\t\t\t\t\t\t<p>Work Experience</p>\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t\t<div id=\"workList\">\t\t\t\t\t</div>\t\t\t\t</div>\t\t\t\t<div class=\"myskill\">\t\t\t\t\t<div class=\"bigTitle skill\">\t\t\t\t\t\t<div class=\"titleName\">\t\t\t\t\t\t\t<p>技能</p>\t\t\t\t\t\t\t<p>My Skills</p>\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t\t<div id=\"skillList\">\t\t\t\t\t<p class=\"skillTitle\">WEB 前端</p>\t\t\t\t\t<div id=\"frontEnd\"></div>\t\t\t\t\t<p class=\"skillTitle\">其他</p>\t\t\t\t\t<div id=\"otherSkill\"></div>\t\t\t\t\t</div>\t\t\t\t</div>\t\t\t</div>\t\t\t<div class=\"right\">\t\t\t\t<div class=\"projectBig\">\t\t\t\t\t<div class=\"bigTitle project\">\t\t\t\t\t\t<div class=\"titleName\">\t\t\t\t\t\t\t\t<p>项目经验</p>\t\t\t\t\t\t\t<p>Project Experience</p>\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t\t<div class=\"projectList\">\t\t\t\t\t\t<p class=\"skillTitle\">我的项目</p>\t\t\t\t\t\t<div id=\"projectList\"></div>\t\t\t\t\t</div>\t\t\t\t</div>\t\t\t\t<div class=\"schoolBig\">\t\t\t\t\t<div class=\"bigTitle school\">\t\t\t\t\t\t<div class=\"titleName\">\t\t\t\t\t\t\t\t<p>校园经历</p>\t\t\t\t\t\t\t<p>school Experience</p>\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t\t<div class=\"projectList\">\t\t\t\t\t\t<p class=\"skillTitle\">我的实践</p>\t\t\t\t\t\t<div id=\"school\"></div>\t\t\t\t\t</div>\t\t\t\t</div>\t\t\t</div>\t\t</section>\t\t<script src=\"resource/index.js\"></script>\t</div></body></html>"
