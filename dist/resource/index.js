...
/***/ function(module, exports, __webpack_require__) {
	...
	topHtml = __webpack_require__(3),
	    ...
	    schoolHtml = __webpack_require__(14),
	    topcss = __webpack_require__(15),
	    resume = __webpack_require__(28);
...
/***/ function(module, exports) {
	...
	module.exports = "<!DOCTYPE html><html lang=\"en\"><head>\t<meta charset=\"UTF-8\">\t<meta name=\"viewport\"    content=\"width=device-width,user-scalable=no,initial-scale=1.0,maximum-scale=1,minimum-scale=1\">\t<title>My resume</title></head><body id=\"body\" style=\"display: none;\">\t<div class=\"wrapper\">\t\t<section id=\"top\"></section> \t\t<section id=\"content\">\t\t\t<div class=\"left\">\t\t\t\t<div class=\"mywork\" >\t\t\t\t\t<div class=\"bigTitle work\">\t\t\t\t\t\t<div class=\"titleName\">\t\t\t\t\t\t\t\t<p>工作经验</p>\t\t\t\t\t\t\t<p>Work Experience</p>\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t\t<div id=\"workList\">\t\t\t\t\t</div>\t\t\t\t</div>\t\t\t\t<div class=\"myskill\">\t\t\t\t\t<div class=\"bigTitle skill\">\t\t\t\t\t\t<div class=\"titleName\">\t\t\t\t\t\t\t<p>技能</p>\t\t\t\t\t\t\t<p>My Skills</p>\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t\t<div id=\"skillList\">\t\t\t\t\t<p class=\"skillTitle\">WEB 前端</p>\t\t\t\t\t<div id=\"frontEnd\"></div>\t\t\t\t\t<p class=\"skillTitle\">其他</p>\t\t\t\t\t<div id=\"otherSkill\"></div>\t\t\t\t\t</div>\t\t\t\t</div>\t\t\t</div>\t\t\t<div class=\"right\">\t\t\t\t<div class=\"projectBig\">\t\t\t\t\t<div class=\"bigTitle project\">\t\t\t\t\t\t<div class=\"titleName\">\t\t\t\t\t\t\t\t<p>项目经验</p>\t\t\t\t\t\t\t<p>Project Experience</p>\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t\t<div class=\"projectList\">\t\t\t\t\t\t<p class=\"skillTitle\">我的项目</p>\t\t\t\t\t\t<div id=\"projectList\"></div>\t\t\t\t\t</div>\t\t\t\t</div>\t\t\t\t<div class=\"schoolBig\">\t\t\t\t\t<div class=\"bigTitle school\">\t\t\t\t\t\t<div class=\"titleName\">\t\t\t\t\t\t\t\t<p>校园经历</p>\t\t\t\t\t\t\t<p>school Experience</p>\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t\t<div class=\"projectList\">\t\t\t\t\t\t<p class=\"skillTitle\">我的实践</p>\t\t\t\t\t\t<div id=\"school\"></div>\t\t\t\t\t</div>\t\t\t\t</div>\t\t\t</div>\t\t</section>\t\t<script src=\"resource/index.js\"></script>\t</div></body></html>"

/***/ },
/* 3 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = "<div  class=\"top\" >\t<div class=\"message\">\t\t<p class=\"name\">{{resume.name}}</p>\t\t<p class=\"profession\">{{resume.profession}}</p>\t</div>\t<ul class=\"personal\">\t\t<li class=\"personalList\"><img src="+JSON.stringify(__webpack_require__(4))+"><span>{{resume.email}}</span></li>\t\t<li class=\"personalList\"><img src="+JSON.stringify(__webpack_require__(5))+"><span>{{resume.wechat}}</span></li>\t\t<li class=\"personalList\"><img src="+JSON.stringify(__webpack_require__(6))+"><span>{{resume.github}}</span></li>\t\t<li class=\"personalList\"><img src="+JSON.stringify(__webpack_require__(7))+"><span>{{resume.telephone}}</span></li>\t\t<li class=\"personalList\"><img src="+JSON.stringify(__webpack_require__(8))+"><span>{{resume.school}}</span></li>\t</ul>\t<div class=\"photo\">\t\t<img src="+JSON.stringify(__webpack_require__(9))+" alt=\"my personal photo\">\t</div></div><!-- <p style=\"text-align: center\">为方便查看各个项目代码与实例，可访问网页版简历：https://shanminlv.github.io/resumeProject/dist/index.html</p> -->"
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"workExperience": [
			{
				"company": "<strong class='red'>平安科技（深圳）有限公司</strong>",
				"date": "2016.07 ~ 至今",
				"job": "前端开发工程师",
				"detail": [
			...
			{
				"company": "<strong class='red'>唯品会</strong>",
		...
		"frontEnd": [
			{
				"skillName": "<strong class='red'>vue</strong>",
				"listDetail": [
					"能使用vue，vue-router，vuex和vue-cli开发单页项目。"
				]
			},
			{
				"skillName": "ReactJS",
			...
			},
			{
				"skillName": "前端工程化",
				"listDetail": [
					"基本会gulp和<strong class='red'>webpack</strong>，并运用gulp和webpack开发了多个个人项目。"
				]
			},
			{
		...
		"otherSkill": [
			"能运用<strong class='red'>Node.js</strong>搭建服务器，并运用Node.js开发了个人项目。",
			"简单使用过MongoDB，可以用Node.js对数据进行增减删操作。",
			"基本会使用Photoshop设计美化图片。"
		],
		"project": [
			{
				"name": "<strong class='red'>vue简历生成工具</strong>",
			...
			{
				"name": "<strong class='red'>成长点滴webapp</strong>",
				"code": "https://github.com/shanminlv/develop-chatApp",
				"demo": "",
				"time": "2016.01-2016.03",
				"detail": [
			...
			},
			{
				...
				"code": "",
				"demo": "",
				"time": "2017.02－2016.03",
				"detail": [
					"运用zepto.js和LABjs对原来的代码进行重构。",
					"运用svn进行合作开发项目。",
					"使用sessionStorage对用户数据进行存储。",
					"提取公共代码，提高代码重用率,优化代码提高代码效率与可读性。"
				]
			},
			{
				"name": "个人网页简历",
			...
			},
			{
				...
				"demo": "https://shanminlv.github.io/pctool/index.html",
				"time": "2015.12",
				"detail": [
