...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = "<div  class=\"top\" >\r\t<div class=\"photo\">\r\t\t<img src="+JSON.stringify(__webpack_require__(4))+" alt=\"my personal photo\">\r\t</div>\r\t<div class=\"webResume\" style=\"display: block;\">\r\t\t<p>扫码访问网页版简历</p>\t\t\r\t\t<img src="+JSON.stringify(__webpack_require__(5))+" alt=\"my personal webResume\">\r\t</div>\r\t<div class=\"message\">\r\t\t<p class=\"name\">{{resume.name}}</p>\r\t\t<p class=\"profession\">{{resume.profession}}</p>\r\t</div>\r\t<ul class=\"personal\">\r\t\t<li class=\"personalList\"><img src="+JSON.stringify(__webpack_require__(6))+"><span>{{resume.email}}</span></li>\r\t\t<li class=\"personalList\"><a href=\"{{resume.github}}\" target=\"_blank\"><img src="+JSON.stringify(__webpack_require__(7))+"><span>{{resume.github}}</span></a></li>\r\t\t<li class=\"personalList\"><img src="+JSON.stringify(__webpack_require__(8))+"><span>{{resume.telephone}}</span></li>\r\t\t<li class=\"personalList\"><img src="+JSON.stringify(__webpack_require__(9))+"><span>{{resume.school}}</span></li>\r\t</ul>\r</div><!-- \r<p style=\"text-align: center\">为方便查看各个项目代码与实例，可访问网页版简历：https://shanminlv.github.io/resumeProject/dist/index.html</p> -->"
...
/***/ (function(module, exports) {
	...
	module.exports = {"name":"吕善敏","school":"华南师范大学（2012-2016）","education":"本科","telephone":"15625102090","email":"416668495@qq.com","github":"https://github.com/shanminlv","profession":"前端开发工程师","workExperience":[{"company":"品今科技有限公司","date":"2018.09 ~ 2019.10","job":"<strong class='red'>前端组长</strong>","detail":["开发公司的小程序。","管理前端团队。","根据公司业务使用webpack4构建架构项目。","轻遇项目的react-native研发。","前端页面错误自动化监控。"]},{"company":"讯汇科技（广州）有限公司","date":"2017.05 ~ 2018.09","job":"<strong class='red'>前端组长</strong>","detail":["使用Jenkins集成gulp和webpack，自动部署页面。","运用vue主导公司pc端直播项目的开发。","运用vue主导公司H5直播项目的开发。","解决直播项目中遇到的各类难题。","编写nodejs爬虫。"]},{"company":"平安科技（深圳）有限公司","date":"2016.07 ~ 2017.04","job":"前端开发工程师","detail":["运用JQuery参与非车保险H5页面的开发。","使用zepto对非车保险出单产品模版进行代码重构。"]},{"company":"唯品会","date":"2015.07-2015.12","job":"前端开发（实习）","detail":["负责公司专题网购页面的日常更新。","运用ajax、css3动画、angular.js进行专题组件的开发。","使用JavaScript对旧专题模板进行开发。"]}],"frontEnd":[{"skillName":"Vue","listDetail":["精通vue，能熟练运用vue,vue-router，vuex和vue-cli开发单页或多页项目。","使用vue服务端渲染，进行前后端同构。"]},{"skillName":"webpack/jenkins","listDetail":["熟练使用webpack，能根据公司业务实现前端工程化与持续集成,使用jenkins实现自动部署"]},{"skillName":"微信小程序","listDetail":["熟练使用微信小程序"]},{"skillName":"ReactJS/react-native","listDetail":["基本会使用ReactJS和react-native"]},{"skillName":"HTML/CSS/JavaScript/jQuery/webview/AngularJS","listDetail":["熟悉使的JS,jQuery,CSS3，SASS，HTML5和webview的交互，基本会使用AngularJS。"]}],"otherSkill":["能运用<strong class='red'>Node.js</strong>搭建服务器，并运用Node.js开发了个人项目。","简单使用过MongoDB，可以用Node.js对数据进行增减删操作。"],"project":[{"name":"<strong class='red'>前端项目集成优化</strong>","time":"","code":"","demo":"","detail":["使用Jenkins集成gulp和webpack，自动部署页面。","使用webpack4的工程化手段进行性能优化，提取公用代码，懒加载等。","实现类似node_module公司定制化的组件库。","根据公司业务实现多套活动模板。","实现增量发布部署后过期的冗余文件自动删除。","h5页面性能优化。","前端页面错误自动化监控。"]},{"name":"<strong class='red'>讯汇科技pc端直播项目</strong>","time":"2017.5-2018.9","code":"","demo":"","detail":["使用vue,vuex,vue-router,vue-resource架构项目，以及配置webpack进行多页开发。","使用js和flash交互，进行rtmp的推流和播放，解决了音频视频不同步，弱网络判断，多条流媒体链接等技术难点。","首屏网站性能优化处理。","实现富文本编辑器并解决各个浏览器的兼容性问题。","运用独自封装的socket.js和服务器进行rpc交互,支持成功，失败，超时回调。","解决ie跨域不带cookie，各个浏览器flash的不同支持和浏览器缓存策略等兼容性问题。"]},{"name":"<strong class='red'>讯汇科技H5直播项目</strong>","time":"2017.5-2018.9","code":"","demo":"","detail":["使用rem进行屏幕自适应。","使用flvjs解决了m3u8播放延时。","解决了手机浏览器跨域不带cookie、video元素的全屏播放和网络缓慢不能继续播放等问题。"]},{"name":"品今小程序","time":"","code":"","demo":"","detail":["解决多条socket链接的问题。","对page，wx.request和socket进行封装。"]},{"name":"成长点滴webapp","code":"https://github.com/shanminlv/develop-chatApp","demo":"","time":"2016.01-2016.03","detail":["运用node.js实现静态资源管理、socket.io模块实现聊天功能、fs模块实现文件的操作和数据的存储。","运用angular.js的控制器、指令、服务、过滤器和bootstrap构建前端。","数据库运用MongoDB。"]},{"name":"非车保险H5旧模版的项目重构","code":"","demo":"","time":"2017.02－2016.03","detail":["运用zepto.js和LABjs对原来的代码进行重构。","提取公共代码，提高代码重用率,优化代码提高代码效率与可读性。"]},{"name":"页面代码生成器","code":"https://github.com/shanminlv/pctool","demo":"https://shanminlv.github.io/pctool/index.html","time":"2015.12","detail":["个人运用canvas、file API、拖放、开发了日常需求页面的代码生成器。提高了公司的开发效率。"]},{"name":"vue简历生成工具","code":"https://github.com/shanminlv/vue-resume","demo":"https://shanminlv.github.io/vue-resume/dist/index.html#/edit/resumeBlue","time":"2017.01","detail":["运用htmltocanvas，jspdf，file API，new Blob导出图片版，网页版和pdf版简历。"]}]}
